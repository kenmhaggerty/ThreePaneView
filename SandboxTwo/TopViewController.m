...
{
    [self.threePaneViewController viewMainView];
}

- (IBAction)popMainView:(UIButton *)sender
{
    [self.threePaneViewController popMainView];
}
...
{
    [self.threePaneViewController viewTopView];
}

- (IBAction)popTopView:(UIButton *)sender
{
    [self.threePaneViewController popTopView];
}
...
{
    [self.threePaneViewController viewSideView];
}

- (IBAction)popSideView:(UIButton *)sender
{
    [self.threePaneViewController popSideView];
}
